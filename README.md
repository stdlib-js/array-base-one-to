...
```javascript
import oneTo from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-one-to@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-one-to@v0.2.3-deno/mod.js';
```
